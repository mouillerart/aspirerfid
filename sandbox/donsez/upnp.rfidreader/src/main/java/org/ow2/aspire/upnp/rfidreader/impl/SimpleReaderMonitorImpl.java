...
{
    private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(Acr122TagReader.class.getName());
    ...
    public void onReaderEvent(ReaderEvent readerEvent)
    {
        if(readerEvent.getEventType().equals(com.tikitag.client.tagservice.ReaderEvent.ReaderEventType.READER_ADDED))
        {
            ...
            {
            	String msg="New reader detected, but already discovered, no further action.";
