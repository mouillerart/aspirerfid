...
public class LowPowerDevice extends AbstractUPnPService {
	...
	stateVariables.put(
		"BatteryLow",
		new BatteryLowStateVariable(this,model)
	);
	...
	stateVariables.put(
		"SleepPeriod",
		new SleepPeriodStateVariable(this,model)
	);
	...
	stateVariables.put(
		"PowerState",
		new PowerStateStateVariable(this,model)
	);
	...
	stateVariables.put(
		"WakeupMethod",
		new WakeupMethodStateVariable(this,model)
	);
	...
	actions.put(
		"GetPowerManagementInfo",
		new GetPowerManagementInfoAction(this,model)
	);
	...
	actions.put(
		"GoToSleep",
		new GoToSleepAction(this,model)
	);
...
public class ExternalPowerSupplySourceStateVariable
  extends AbstractUPnPStateVariable
	...
	public ExternalPowerSupplySourceStateVariable(
...
public class BatteryLowStateVariable
  extends AbstractUPnPStateVariable
	...
	public BatteryLowStateVariable(
		UPnPService upnpService,
		LowPowerDeviceModel model
	){	
		super(
...
public class PowerSupplyStatusStateVariable
  extends AbstractUPnPStateVariable
	...
	public PowerSupplyStatusStateVariable(
		UPnPService upnpService,
		LowPowerDeviceModel model
	){	
		super(
...
public class SleepPeriodStateVariable
  extends AbstractUPnPStateVariable
	...
	public SleepPeriodStateVariable(
		UPnPService upnpService,
		LowPowerDeviceModel model
	){	
		super(
...
public class PowerStateStateVariable
  extends AbstractUPnPStateVariable
	...
	public PowerStateStateVariable(
		UPnPService upnpService,
		LowPowerDeviceModel model
	){	
		super(
...
public class WakeupMethodStateVariable
  extends AbstractUPnPStateVariable
	...
	public WakeupMethodStateVariable(
		UPnPService upnpService,
		LowPowerDeviceModel model
	){	
		super(
...
public class GetPowerManagementInfoAction extends AbstractUPnPAction {
	...
	public GetPowerManagementInfoAction(
	    UPnPService upnpService,
		LowPowerDeviceModel model
	){
		super(
		...
		this.model=model;
			...
			addOutArg(
				"WakeupMethod",
				upnpService.getStateVariable("WakeupMethod")
			);
		
			addOutArg(
				"PowerSupplyStatus",
				upnpService.getStateVariable("PowerSupplyStatus")
			);
...
public class GoToSleepAction extends AbstractUPnPAction {
	...
	public GoToSleepAction(
		...
		this.model=model;
			...
			addInArg(
				"RecommendedSleepPeriod",
				upnpService.getStateVariable("SleepPeriod")
			);
		
			addInArg(
				"RecommendedPowerState",
				upnpService.getStateVariable("PowerState")
			);
	...
	java.lang.Integer recommendedSleepPeriod = (java.lang.Integer) _args.get("RecommendedSleepPeriod");
		java.lang.String recommendedPowerState = (java.lang.String) _args.get("RecommendedPowerState");
