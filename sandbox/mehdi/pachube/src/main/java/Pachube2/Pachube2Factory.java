...
import Pachube.Status;
import Pachube.Trigger;
import Pachube.TriggerType;

public class Pachube2Factory {

	/**
	 * Creates a feed from a String
	 * @param p Pachube2 object which is the gateway to the pachube service
	 ...
	 */
	public static Feed toFeed(Pachube2 p, String s) {
		Feed f = new Feed(p);
