...
import bpwme.diagram.edit.policies.CLCBProcItemSemanticEditPolicy;
...
public class CLCBProcEditPart extends ShapeNodeEditPart {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof bpwme.diagram.edit.parts.CLCBProcEditPart) {
			types.add(BpwmeElementTypes.Connection_4001);
		}
	...
	protected void handleNotificationEvent(Notification notification) {
		...
		if((notification.getEventType() == Notification.SET) 
				&& (notification.getNotifier() instanceof bpwme.impl.CLCBProcImpl)) {
