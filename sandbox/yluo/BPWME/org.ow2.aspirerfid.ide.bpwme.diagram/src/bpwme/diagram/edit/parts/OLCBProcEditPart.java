...
import bpwme.diagram.edit.policies.OLCBProcItemSemanticEditPolicy;
...
public class OLCBProcEditPart extends ShapeNodeEditPart {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (targetEditPart instanceof bpwme.diagram.edit.parts.OLCBProcEditPart) {
			types.add(BpwmeElementTypes.Connection_4001);
		}
	...
	protected void handleNotificationEvent(Notification notification) {
		...
		if((notification.getEventType() == Notification.SET) 
				&& (notification.getNotifier() instanceof bpwme.impl.OLCBProcImpl)) {
				//&& (notification.get)) {
