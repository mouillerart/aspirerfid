...
import bpwme.diagram.edit.policies.EBProcItemSemanticEditPolicy;
...
public class EBProcEditPart extends ShapeNodeEditPart {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof bpwme.diagram.edit.parts.EBProcEditPart) {
			types.add(BpwmeElementTypes.Connection_4001);
		}
		return types;
	}
	...
	protected void handleNotificationEvent(Notification notification) {
		...
		if((notification.getEventType() == Notification.SET) 
				&& (notification.getNotifier() instanceof bpwme.impl.EBProcImpl)) {
