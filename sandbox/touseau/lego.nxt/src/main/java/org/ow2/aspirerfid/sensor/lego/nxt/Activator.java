...
import org.ow2.aspirerfid.sensor.lego.nxt.producers.NXTRFIDProducer;
...
public class Activator implements BundleActivator, Runnable {
	...
	private NXTRFIDProducer m_rfidProducer;
	...
	public void run() {
		...
		// RFID producer
		if (m_rfidPort != null){
			m_rfidProducer = new NXTRFIDProducer(m_rfidPort);
