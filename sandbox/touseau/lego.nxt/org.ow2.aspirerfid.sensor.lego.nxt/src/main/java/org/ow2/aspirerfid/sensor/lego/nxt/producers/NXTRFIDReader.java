 ...
 *
 */
public class NXTRFIDReader implements NXTProducer {
	...
	/**
	 * field injected by the iPOJO Event Admin handler
	 */
	...
	public NXTRFIDReader(SensorPort port){
		m_wires = null;
	}
	...
	public void run() {
		...
		// get the RFID reader serial number
		m_readerID = m_rs.getReaderID();
		System.out.println("Reader ID : "+m_readerID);
		
		String prefixTagID = "urn:epc:id:gid:"+m_readerID;
...
//			} else System.out.println("no consumer connected\n"+"tag ID: "+m_tagID);				
			...
			m_publisher.sendData(prefixTagID+m_tagID);
