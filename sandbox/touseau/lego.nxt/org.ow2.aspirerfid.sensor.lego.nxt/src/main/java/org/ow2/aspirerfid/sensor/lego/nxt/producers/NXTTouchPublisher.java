...
public class NXTTouchPublisher implements Runnable {
	...
	private Publisher m_pressedPublisher;
	private Publisher m_releasedPublisher;
	...
	private final long POLL_DELAY = 200;
