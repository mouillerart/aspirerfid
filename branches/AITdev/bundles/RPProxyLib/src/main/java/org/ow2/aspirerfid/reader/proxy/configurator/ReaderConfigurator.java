...
import org.ow2.aspirerfid.rp.proxy.DataSelector;
...
import org.ow2.aspirerfid.rp.proxy.Trigger;
import org.ow2.aspirerfid.rp.proxy.configurator.DataSelectorConfiguration.EventFilters;
import org.ow2.aspirerfid.rp.proxy.configurator.DataSelectorConfiguration.FieldNames;
import org.ow2.aspirerfid.rp.proxy.configurator.DataSelectorConfiguration.TagFields;
import org.ow2.aspirerfid.rp.proxy.configurator.NotificationChannelConfiguration.NotificationTriggers;
import org.ow2.aspirerfid.rp.proxy.factories.DataSelectorFactory;
import org.ow2.aspirerfid.rp.proxy.factories.NotificationChannelFactory;
import org.ow2.aspirerfid.rp.proxy.factories.ReaderDeviceFactory;
import org.ow2.aspirerfid.rp.proxy.factories.TriggerFactory;
...
public class ReaderConfigurator {
	...
	/** the jaxb context */
	private static final String JAXB_CONTEXT = "org.ow2.aspirerfid.rp.proxy.configurator";
	...
	private static void createNotificationChannel(NotificationChannelConfiguration channelConfig) throws RPProxyException {
		...
		// add sources
		org.ow2.aspirerfid.rp.proxy.configurator.NotificationChannelConfiguration.Sources sources = channelConfig.getSources();
		if (sources != null) {
