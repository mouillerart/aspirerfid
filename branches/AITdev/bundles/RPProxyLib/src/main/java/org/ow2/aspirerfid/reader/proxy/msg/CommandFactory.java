...
package org.ow2.aspirerfid.rp.proxy.msg;
...
import org.ow2.aspirerfid.rp.proxy.msg.stubs.DataSelector;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.NotificationChannel;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.ReadPoint;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.Source;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.TagField;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.TagFieldValue;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.TagSelector;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.Trigger;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.DataSelectorSerializer;
...
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.NotificationChannelSerializer;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.ReadPointSerializer;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.ReaderDeviceSerializer;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.SourceSerializer;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.TagFieldSerializer;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.TagSelectorSerializer;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.TriggerSerializer;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.TriggerTypeSerializer;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.xml.DataSelectorSerializerImpl;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.xml.EventTypeSerializerImpl;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.xml.FieldNameSerializerImpl;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.xml.NotificationChannelSerializerImpl;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.xml.ReadPointSerializerImpl;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.xml.ReaderDeviceSerializerImpl;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.xml.SourceSerializerImpl;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.xml.TagFieldSerializerImpl;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.xml.TagSelectorSerializerImpl;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.xml.TriggerSerializerImpl;
import org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.xml.TriggerTypeSerializerImpl;
import org.ow2.aspirerfid.reader.rp.impl.core.ReaderProtocolException;
import org.ow2.aspirerfid.reader.rp.impl.core.msg.MessageSerializingException;
 ...
 * 
 * @author Andreas F�rer, Remo Egli
 */
public class CommandFactory {
	...
	public static String getTextCommand(String object, String command, Parameter[] params, String target) throws ParameterTypeException {
		...
		if (object.equals("ReaderDevice")) {
			ReaderDeviceSerializer rdCommand = new org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.text.ReaderDeviceSerializerImpl(getNextId(), target);
			if (command.equals("getEPC")) {
				return rdCommand.getEPC();
			}
			else if (command.equals("getManufacturer")) {
			...
			SourceSerializer srcCommand = new org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.text.SourceSerializerImpl(getNextId(), target);
			if (command.equals("create")) {
				return srcCommand.create(params[0].getString());
			}
			else if (command.equals("getName")) {
			...
			ReadPointSerializer rpCommand = new org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.text.ReadPointSerializerImpl(getNextId(), target);
			if (command.equals("getName")) {
				return rpCommand.getName();
			}
			...
			TagSelectorSerializer tsCommand = new org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.text.TagSelectorSerializerImpl(getNextId(), target);
			if (command.equals("create")) {
				try {
					TagField tf = TagField.create(params[1].getString());
					return tsCommand.create(params[0].getString(),tf,params[2].getString(), params[3].getString(),params[4].getBoolean());
			...
			DataSelectorSerializer dsCommand = new org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.text.DataSelectorSerializerImpl(getNextId(), target);
			if (command.equals("create")) {
				return dsCommand.create(params[0].getString());
			}
			else if (command.equals("getName")) {
			...
			NotificationChannelSerializer ncCommand = new org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.text.NotificationChannelSerializerImpl(getNextId(), target);
			if (command.equals("create")) {
				return ncCommand.create(params[0].getString(), params[1].getString());
			}
			else if (command.equals("getName")) {
			...
			TriggerSerializer trgCommand = new org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.text.TriggerSerializerImpl(getNextId(),target);
			if (command.equals("create")) {
				return trgCommand.create(params[0].getString(),params[1].getString(),params[2].getString());
			}
			else if (command.equals("getMaxNumberSupported")) {
			...
			EventTypeSerializer evCommand = new org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.text.EventTypeSerializerImpl(getNextId(), target);
			if (command.equals("getSupportedTypes")) {
				return evCommand.getSupportedTypes();
			}
		}
		else if (object.equals("TriggerType")) {
			TriggerTypeSerializer ttCommand = new org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.text.TriggerTypeSerializerImpl(getNextId(), target);
			if (command.equals("getSupportedTypes")) {
				return ttCommand.getSupportedTypes();
			}
			...
			FieldNameSerializer fnCommand = new org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.text.FieldNameSerializerImpl(getNextId(), target);
			if (command.equals("getSupportedNames")) {
				return fnCommand.getSupportedNames();
			}
			...
			TagFieldSerializer tfCommand = new org.ow2.aspirerfid.rp.proxy.msg.stubs.serializers.text.TagFieldSerializerImpl(getNextId(), target);
			if (command.equals("create")) {
				return tfCommand.create(params[0].getString());
			}
			else if (command.equals("getName")) {
	...
	private static String serializeCommand(Command cmd) {
		...
		try {
			if (context == null) {
			   context = JAXBContext
			         .newInstance("org.ow2.aspirerfid.reader.rp.impl.core.msg.command");
			}
			if (marshaller == null) {
