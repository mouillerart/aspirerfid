...
public class WarehouseManagement {
	...
	private void initialize() {
		...
		final JLabel entryDateLabel_3_1_3;
		frame = new JFrame();
		...
		entryDateLabel_3_1_3 = new JLabel();
		entryDateLabel_3_1_3.setText("xxxxxxxxxx...............");
		entryDateLabel_3_1_3.setBounds(51, 91, 117, 16);
		panel.add(entryDateLabel_3_1_3);

		xxxxxxTextField = new JTextField();
		xxxxxxTextField.setBounds(172, 89, 330, 20);
		panel.add(xxxxxxTextField);
