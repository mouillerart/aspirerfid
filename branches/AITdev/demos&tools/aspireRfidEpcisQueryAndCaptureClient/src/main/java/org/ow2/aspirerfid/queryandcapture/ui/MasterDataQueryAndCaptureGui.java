...
public class MasterDataQueryAndCaptureGui {
	...
	protected void createContents() {
		...
		captureInterfaceTestGroup.setBounds(10, 115, 563, 229);

		captureSubmitButton = new Button(captureInterfaceTestGroup, SWT.NONE);
		captureSubmitButton.setBounds(10, 94, 94, 81);
		...
		vLabel_3.setBounds(10, 25, 94, 15);
		vLabel_3.setText("Buissness Step URI:");

		vLabel_2_2 = new Label(captureInterfaceTestGroup, SWT.NONE);
		vLabel_2_2.setBounds(10, 55, 124, 15);
		vLabel_2_2.setText("Buissness Step Attr/Value:");

		buissnessStepUriText = new Text(captureInterfaceTestGroup, SWT.BORDER);
		buissnessStepUriText.setBounds(140, 20, 418, 25);
		...
		buissnessStepAttributeText.setBounds(140, 50, 208, 25);
		...
		buissnessStepValueText.setBounds(354, 50, 203, 25);
		...
		alterelementButton.setBounds(270, 100, 83, 16);
		...
		alterElementsAttributeButton.setBounds(395, 100, 138, 16);

		final Group group = new Group(captureInterfaceTestGroup, SWT.NONE);
		group.setBounds(280, 115, 100, 104);
		...
		group_1.setBounds(410, 115, 107, 80);
		...
		queryInterfaceTestGroup.setBounds(10, 350, 563, 216);
	...
	private void captureSubmitButtonPressed() {
		...
		if (alterElementsAttributeButton.getSelection()) {
			...
			simpleMasterDataInsertionSucceeded = captureClient.simpleMasterDataAndAttributeEdit(EpcisConstants.BUSINESS_STEP_ID, buissnessStepUriText
	...
	private void querySubmitButtonPressed() {
		...
		try {
			...
			vocabularyNames.getString().add("ThisisthetransactionsEPCTag");
