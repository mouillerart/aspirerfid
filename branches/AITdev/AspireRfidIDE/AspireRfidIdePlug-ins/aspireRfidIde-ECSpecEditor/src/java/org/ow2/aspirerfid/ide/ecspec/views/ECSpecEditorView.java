...
public class ECSpecEditorView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		final Button ecspecOpenFileButton = new Button(openExistingFileGroup, SWT.NONE);
		ecspecOpenFileButton.addMouseListener(new EcspecOpenFileButtonMouseListener());
		ecspecOpenFileButton.setBounds(37, 34, 85, 26);
		ecspecOpenFileButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/secure_file_transfer_icon.jpg"));
		...
		ecspecTreeRefreshButton.addMouseListener(new EcspecTreeRefreshButtonMouseListener());
		ecspecTreeRefreshButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/icon_refresh3.png"));
		...
		button.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/ecspeclogo.gif"));
		button.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/ecspeclogo.gif"));
		button.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/ecspeclogo.gif"));
		...
		ECSpecsNode.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/https.png"));
		ECSpecsNode.setText("ECSpecs");

		compositeECSpec = new Composite(composite_3, SWT.BORDER);
		compositeECSpec.setBounds(182, 0, 621, 689);
		compositeECSpec.setBackground(SWTResourceManager.getColor(255, 255, 255));

		final Group ecspecLogicalReadersGroup = new Group(compositeECSpec, SWT.NONE);
		ecspecLogicalReadersGroup.setBackground(SWTResourceManager.getColor(255, 255, 255));
		ecspecLogicalReadersGroup.setText("Logical readers");
		ecspecLogicalReadersGroup.setBounds(10, 0, 600, 150);

		final Label ecspecAvailableLogicalReadersLabel = new Label(ecspecLogicalReadersGroup, SWT.NONE);
		ecspecAvailableLogicalReadersLabel.setBackground(SWTResourceManager.getColor(255, 255, 255));
		ecspecAvailableLogicalReadersLabel.setText("Available:");
		ecspecAvailableLogicalReadersLabel.setBounds(10, 23, 55, 16);

		final Label ecspecIncludedLogicalReadersLabel = new Label(ecspecLogicalReadersGroup, SWT.NONE);
		ecspecIncludedLogicalReadersLabel.setBackground(SWTResourceManager.getColor(255, 255, 255));
		ecspecIncludedLogicalReadersLabel.setText("Included:");
		ecspecIncludedLogicalReadersLabel.setBounds(376, 23, 55, 16);

		final Button ecspecAddReaderButton = new Button(ecspecLogicalReadersGroup, SWT.NONE);
		ecspecAddReaderButton.addMouseListener(new EcspecAddReaderButtonMouseListener());
		ecspecAddReaderButton.setText(">>");
		ecspecAddReaderButton.setBounds(84, 114, 49, 26);

		final Button ecspecTruncateReaderButton = new Button(ecspecLogicalReadersGroup, SWT.NONE);
		ecspecTruncateReaderButton.addMouseListener(new EcspecTruncateReaderButtonMouseListener());
		ecspecTruncateReaderButton.setText("<<");
		ecspecTruncateReaderButton.setBounds(462, 114, 49, 26);

		ecspecAvailableReadersList = new List(ecspecLogicalReadersGroup, SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER);
		ecspecAvailableReadersList.setBackground(SWTResourceManager.getColor(230, 230, 230));
		...
		ecspecIncludedReadersList = new List(ecspecLogicalReadersGroup, SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER);
		ecspecIncludedReadersList.setBackground(SWTResourceManager.getColor(230, 230, 230));
		...
		final Button ecspecAddNewReaderButton = new Button(ecspecLogicalReadersGroup, SWT.NONE);
		ecspecAddNewReaderButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/iconAddOnPackage.gif"));
		ecspecAddNewReaderButton.addMouseListener(new EcspecAddNewReaderButtonMouseListener());
		...
		final TabItem ecspecReportSpecsTabItem = new TabItem(tabFolder, SWT.NONE);
		ecspecReportSpecsTabItem.setText("reportSpec");

		final Composite compositeECReportSpec = new Composite(tabFolder, SWT.NONE);
		compositeECReportSpec.setBackground(SWTResourceManager.getColor(255, 255, 255));
		ecspecReportSpecsTabItem.setControl(compositeECReportSpec);

		final Label ecReportSpecReportNameLabel = new Label(compositeECReportSpec, SWT.NONE);
		ecReportSpecReportNameLabel.setBackground(SWTResourceManager.getColor(255, 255, 255));
		...
		reportNameText.setBackground(SWTResourceManager.getColor(230, 230, 230));
		reportNameText.setBounds(90, 18, 180, 22);

		final Label ecReportSpecReportSpecLabel = new Label(compositeECReportSpec, SWT.NONE);
		ecReportSpecReportSpecLabel.setBackground(SWTResourceManager.getColor(255, 255, 255));
		ecReportSpecReportSpecLabel.setText("Report set:");
		ecReportSpecReportSpecLabel.setBounds(338, 21, 57, 16);

		ecReportSpecReportSetCombo = new Combo(compositeECReportSpec, SWT.READ_ONLY);
		ecReportSpecReportSetCombo.setBackground(SWTResourceManager.getColor(230, 230, 230));
		ecReportSpecReportSetCombo.select(0);
		ecReportSpecReportSetCombo.setItems(new String[] { "CURRENT", "ADDITIONS", "DELETIONS" });
		ecReportSpecReportSetCombo.setBounds(401, 18, 180, 22);

		final TabFolder ecReportSpecFilterSpecTabFolder = new TabFolder(compositeECReportSpec, SWT.NONE);
		ecReportSpecFilterSpecTabFolder.setBackground(SWTResourceManager.getColor(255, 255, 255));
		ecReportSpecFilterSpecTabFolder.setBounds(10, 62, 570, 194);

		final TabItem ecReportSpecFilterSpecTabItem = new TabItem(ecReportSpecFilterSpecTabFolder, SWT.NONE);
		ecReportSpecFilterSpecTabItem.setText("filterSpec");

		final TabItem ecReportSpecGroupSpecTabItem = new TabItem(ecReportSpecFilterSpecTabFolder, SWT.NONE);
		ecReportSpecGroupSpecTabItem.setText("groupSpec");

		final TabItem ecReportSpecOutputTabItem = new TabItem(ecReportSpecFilterSpecTabFolder, SWT.NONE);
		ecReportSpecOutputTabItem.setText("reportOutputSpec");

		final Composite compositeECReportSpecOutput = new Composite(ecReportSpecFilterSpecTabFolder, SWT.NONE);
		...
		includeRawDecimalCheck = new Button(compositeECReportSpecOutput, SWT.CHECK);
		...
		final Composite compositeECReportSpecGroupSpec = new Composite(ecReportSpecFilterSpecTabFolder, SWT.NONE);
		ecReportSpecGroupSpecTabItem.setControl(compositeECReportSpecGroupSpec);

		final Label patternLabel = new Label(compositeECReportSpecGroupSpec, SWT.NONE);
		patternLabel.setText("Pattern:");
		patternLabel.setBounds(10, 21, 43, 16);

		groupSpecURIPatternText = new Text(compositeECReportSpecGroupSpec, SWT.BORDER);
		groupSpecURIPatternText.setBackground(SWTResourceManager.getColor(230, 230, 230));
		groupSpecURIPatternText.setBounds(62, 18, 130, 22);

		final Button patternAddButton = new Button(compositeECReportSpecGroupSpec, SWT.NONE);
		patternAddButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/Add_icon.gif"));
		...
		final Label label_8 = new Label(compositeECReportSpecGroupSpec, SWT.SEPARATOR | SWT.HORIZONTAL);
		label_8.setBounds(10, 74, 245, 8);

		final Label patternListLabel = new Label(compositeECReportSpecGroupSpec, SWT.NONE);
		...
		patternList = new List(compositeECReportSpecGroupSpec, SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER);
		...
		patternList.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				groupSpecURIPatternText.setText(patternList.getItem(patternListSelectedIndex));
			}
		});

		final Button patternUpdateButton = new Button(compositeECReportSpecGroupSpec, SWT.NONE);
		patternUpdateButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/Automatic_Update_icon.jpg"));
		patternUpdateButton.addMouseListener(new PatternUpdateButtonMouseListener());
		patternUpdateButton.setText("Update");
		patternUpdateButton.setBounds(179, 88, 76, 26);

		final Button patternDeleteButton = new Button(compositeECReportSpecGroupSpec, SWT.NONE);
		patternDeleteButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/delete_icon_2.gif"));
		patternDeleteButton.addMouseListener(new PatternDeleteButtonMouseListener());
		patternDeleteButton.setText("Delete");
		patternDeleteButton.setBounds(179, 120, 76, 26);

		final Composite compositeECReportSpecFilterSpec = new Composite(ecReportSpecFilterSpecTabFolder, SWT.NONE);
		ecReportSpecFilterSpecTabItem.setControl(compositeECReportSpecFilterSpec);

		final Label includePatternsLabel = new Label(compositeECReportSpecFilterSpec, SWT.NONE);
		includePatternsLabel.setText("Include patterns:");
		includePatternsLabel.setBounds(10, 21, 92, 16);

		includePatternsText = new Text(compositeECReportSpecFilterSpec, SWT.BORDER);
		includePatternsText.setBackground(SWTResourceManager.getColor(230, 230, 230));
		includePatternsText.setBounds(108, 18, 84, 22);

		final Label excludePatternsLabel = new Label(compositeECReportSpecFilterSpec, SWT.NONE);
		excludePatternsLabel.setText("Exclude patterns:");
		excludePatternsLabel.setBounds(307, 21, 94, 16);

		excludePatternsText = new Text(compositeECReportSpecFilterSpec, SWT.BORDER);
		excludePatternsText.setBackground(SWTResourceManager.getColor(230, 230, 230));
		excludePatternsText.setBounds(407, 18, 84, 22);

		final Button includePatternsAddButton = new Button(compositeECReportSpecFilterSpec, SWT.NONE);
		includePatternsAddButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/Add_icon.gif"));
		includePatternsAddButton.addMouseListener(new IncludePatternsAddButtonMouseListener());
		includePatternsAddButton.setText("Add");
		includePatternsAddButton.setBounds(198, 16, 57, 26);

		final Button excludePatternsAddButton = new Button(compositeECReportSpecFilterSpec, SWT.NONE);
		excludePatternsAddButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/Add_icon.gif"));
		excludePatternsAddButton.addMouseListener(new ExcludePatternsAddButtonMouseListener());
		excludePatternsAddButton.setText("Add");
		excludePatternsAddButton.setBounds(497, 16, 57, 26);

		includePatternsList = new List(compositeECReportSpecFilterSpec, SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER);
		includePatternsList.setBackground(SWTResourceManager.getColor(230, 230, 230));
		...
		includePatternsList.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				includePatternsText.setText(includePatternsList.getItem(includePatternsListSelectedIndex));
			}
		});

		final Button includePatternsUpdateButton = new Button(compositeECReportSpecFilterSpec, SWT.NONE);
		includePatternsUpdateButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/Automatic_Update_icon.jpg"));
		includePatternsUpdateButton.addMouseListener(new IncludePatternsUpdateButtonMouseListener());
		includePatternsUpdateButton.setText("Update");
		includePatternsUpdateButton.setBounds(179, 91, 76, 26);

		final Button includePatternsDeleteButton = new Button(compositeECReportSpecFilterSpec, SWT.NONE);
		includePatternsDeleteButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/delete_icon_2.gif"));
		includePatternsDeleteButton.addMouseListener(new IncludePatternsDeleteButtonMouseListener());
		includePatternsDeleteButton.setText("Delete");
		includePatternsDeleteButton.setBounds(179, 123, 76, 26);

		final Label label = new Label(compositeECReportSpecFilterSpec, SWT.SEPARATOR | SWT.HORIZONTAL);
		label.setBounds(10, 77, 245, 8);

		final Label includePatternsListLabel = new Label(compositeECReportSpecFilterSpec, SWT.NONE);
		includePatternsListLabel.setForeground(SWTResourceManager.getColor(0, 0, 255));
		includePatternsListLabel.setText("Include patterns list");
		includePatternsListLabel.setBounds(10, 59, 111, 16);

		excludePatternsList = new List(compositeECReportSpecFilterSpec, SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER);
		excludePatternsList.setBackground(SWTResourceManager.getColor(230, 230, 230));
		...
		excludePatternsList.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				excludePatternsText.setText(excludePatternsList.getItem(excludePatternsListSelectedIndex));
			}
		});

		final Button excludePatternsUpdateButton = new Button(compositeECReportSpecFilterSpec, SWT.NONE);
		excludePatternsUpdateButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/Automatic_Update_icon.jpg"));
		excludePatternsUpdateButton.addMouseListener(new ExcludePatternsUpdateButtonMouseListener());
		excludePatternsUpdateButton.setText("Update");
		excludePatternsUpdateButton.setBounds(476, 91, 78, 26);

		final Button excludePatternsDeleteButton = new Button(compositeECReportSpecFilterSpec, SWT.NONE);
		excludePatternsDeleteButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/delete_icon_2.gif"));
		excludePatternsDeleteButton.addMouseListener(new ExcludePatternsDeleteButtonMouseListener());
		excludePatternsDeleteButton.setText("Delete");
		excludePatternsDeleteButton.setBounds(476, 123, 78, 26);

		final Label label_7 = new Label(compositeECReportSpecFilterSpec, SWT.SEPARATOR | SWT.HORIZONTAL);
		label_7.setBounds(307, 77, 247, 8);

		final Label excludePatternsListLabel = new Label(compositeECReportSpecFilterSpec, SWT.NONE);
		excludePatternsListLabel.setForeground(SWTResourceManager.getColor(0, 0, 255));
		...
		reportIfEmptyCheck.setBackground(SWTResourceManager.getColor(255, 255, 255));
		...
		reportOnlyOnChangeCheck.setBackground(SWTResourceManager.getColor(255, 255, 255));
		reportOnlyOnChangeCheck.setText("Report Only On Change");
		reportOnlyOnChangeCheck.setBounds(429, 262, 153, 16);

		final Label label_3 = new Label(compositeECReportSpec, SWT.SEPARATOR | SWT.HORIZONTAL);
		label_3.setBackground(SWTResourceManager.getColor(255, 255, 255));
		label_3.setBounds(11, 282, 570, 10);

		final Button reportAddButton = new Button(compositeECReportSpec, SWT.NONE);
		reportAddButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/calAddIcon.gif"));
		...
		reportsList = new List(compositeECReportSpec, SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER);
		...
		final Button reportSpecsUpdateButton = new Button(compositeECReportSpec, SWT.NONE);
		reportSpecsUpdateButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/Automatic_Update_icon.jpg"));
		reportSpecsUpdateButton.addMouseListener(new ReportSpecsUpdateButtonMouseListener());
		reportSpecsUpdateButton.setText("Update");
		reportSpecsUpdateButton.setBounds(179, 360, 76, 26);

		final Button reportSpecsDeleteButton = new Button(compositeECReportSpec, SWT.NONE);
		reportSpecsDeleteButton.addMouseListener(new ReportSpecsDeleteButtonMouseListener());
		reportSpecsDeleteButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/delete_icon_2.gif"));
		reportSpecsDeleteButton.setText("Delete");
		reportSpecsDeleteButton.setBounds(179, 392, 76, 26);

		final Label label_1 = new Label(compositeECReportSpec, SWT.SEPARATOR | SWT.HORIZONTAL);
		label_1.setBackground(SWTResourceManager.getColor(255, 255, 255));
		label_1.setBounds(10, 347, 571, 10);

		final Label reportsListLabel = new Label(compositeECReportSpec, SWT.NONE);
		reportsListLabel.setBackground(SWTResourceManager.getColor(255, 255, 255));
		...
		final Button resetReportButton = new Button(compositeECReportSpec, SWT.NONE);
		resetReportButton.addMouseListener(new ResetReportButtonMouseListener());
		resetReportButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/delete_icon.gif"));
		resetReportButton.setText("Reset report");
		resetReportButton.setBounds(107, 295, 96, 26);

		final Composite compositeECBoundarySpec = new Composite(tabFolder, SWT.NONE);
		...
		ecBoundarySpecStartTriggerText.setBackground(SWTResourceManager.getColor(230, 230, 230));
		...
		ecBoundarySpecStopTriggerText.setBackground(SWTResourceManager.getColor(230, 230, 230));
		...
		ecBoundarySpecRepeatPeriodValueText.addVerifyListener(new EcBoundarySpecRepeatPeriodValueTextVerifyListener());
		ecBoundarySpecRepeatPeriodValueText.setBounds(81, 204, 95, 22);
		ecBoundarySpecRepeatPeriodValueText.setBackground(SWTResourceManager.getColor(230, 230, 230));
		...
		ecBoundarySpecDurationValueText.addVerifyListener(new EcBoundarySpecDurationValueTextVerifyListener());
		ecBoundarySpecDurationValueText.setBounds(81, 265, 95, 22);
		ecBoundarySpecDurationValueText.setBackground(SWTResourceManager.getColor(230, 230, 230));

		final Label ecBoundarySpecStableSetIntervalLabel = new Label(group, SWT.NONE);
		ecBoundarySpecStableSetIntervalLabel.setBounds(11, 301, 105, 16);
		ecBoundarySpecStableSetIntervalLabel.setForeground(SWTResourceManager.getColor(0, 0, 255));
		...
		ecBoundarySpecStableSetIntervalValueText.addVerifyListener(new EcBoundarySpecStableSetIntervalValueTextVerifyListener());
		ecBoundarySpecStableSetIntervalValueText.setBounds(81, 329, 95, 22);
		ecBoundarySpecStableSetIntervalValueText.setBackground(SWTResourceManager.getColor(230, 230, 230));

		final Label startTriggerListLabel = new Label(group, SWT.NONE);
		startTriggerListLabel.setForeground(SWTResourceManager.getColor(0, 0, 255));
		...
		ecspecStartTriggerAddButton.addMouseListener(new EcspecStartTriggerAddButtonMouseListener());
		ecspecStartTriggerAddButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/Add_icon.gif"));
		...
		ecspecStopTriggerAddButton.addMouseListener(new EcspecStopTriggerAddButtonMouseListener());
		ecspecStopTriggerAddButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/Add_icon.gif"));
		...
		stopTriggerListLabel.setForeground(SWTResourceManager.getColor(0, 0, 255));
		...
		ecspecStartTriggerList = new List(group, SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER);
		ecspecStartTriggerList.setBackground(SWTResourceManager.getColor(230, 230, 230));
		...
		ecspecStartTriggerList.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				ecBoundarySpecStartTriggerText.setText(ecspecStartTriggerList.getItem(startTriggerListSelectedIndex));
			}
		});

		final Button ecspecStartTriggerListUpdateButton = new Button(group, SWT.NONE);
		ecspecStartTriggerListUpdateButton.addMouseListener(new EcspecStartTriggerListUpdateButtonMouseListener());
		ecspecStartTriggerListUpdateButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/Automatic_Update_icon.jpg"));
		ecspecStartTriggerListUpdateButton.setText("Update");
		ecspecStartTriggerListUpdateButton.setBounds(200, 97, 76, 26);

		final Button ecspecStartTriggerListDeleteButton = new Button(group, SWT.NONE);
		ecspecStartTriggerListDeleteButton.addMouseListener(new EcspecStartTriggerListDeleteButtonMouseListener());
		ecspecStartTriggerListDeleteButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/delete_icon_2.gif"));
		ecspecStartTriggerListDeleteButton.setText("Delete");
		ecspecStartTriggerListDeleteButton.setBounds(200, 129, 76, 26);

		ecspecStopTriggerList = new List(group, SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER);
		ecspecStopTriggerList.setBackground(SWTResourceManager.getColor(230, 230, 230));
		...
		ecspecStopTriggerList.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				List list = (List) e.getSource();
				startTriggerListSelectedIndex = list.getSelectionIndex();
				ecBoundarySpecStopTriggerText.setText(ecspecStopTriggerList.getItem(stopTriggerListSelectedIndex));
			}
		});

		final Button ecspecStopTriggerListUpdateButton = new Button(group, SWT.NONE);
		ecspecStopTriggerListUpdateButton.addMouseListener(new EcspecStopTriggerListUpdateButtonMouseListener());
		ecspecStopTriggerListUpdateButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/Automatic_Update_icon.jpg"));
		ecspecStopTriggerListUpdateButton.setText("Update");
		ecspecStopTriggerListUpdateButton.setBounds(486, 96, 76, 26);

		final Button ecspecStopTriggerListDeleteButton = new Button(group, SWT.NONE);
		ecspecStopTriggerListDeleteButton.addMouseListener(new EcspecStopTriggerListDeleteButtonMouseListener());
		ecspecStopTriggerListDeleteButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/delete_icon_2.gif"));
		...
		final Button ecspecGenerateXMLButton = new Button(compositeECSpec, SWT.NONE);
		ecspecGenerateXMLButton.addMouseListener(new EcspecGenerateXMLButtonMouseListener());
		ecspecGenerateXMLButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/recording-launch.gif"));
		...
		ecspecResetButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/icon_delete_tag.gif"));
		ecspecResetButton.addMouseListener(new EcspecResetButtonMouseListener());
		ecspecResetButton.setText("Reset");
		ecspecResetButton.setBounds(179, 655, 64, 26);

		final Label label_2 = new Label(compositeECSpec, SWT.SEPARATOR | SWT.HORIZONTAL);
		...
		includeSpecInReportCheckBox.setBackground(SWTResourceManager.getColor(255, 255, 255));
		...
		ecspecSaveButton.setImage(ResourceManager.getPluginImage(Activator.getDefault(), "icons/img/b_save.png"));
		...
		if (ECSpecDirectoryContents.length != 0) {
			for (int i = 0; i < ECSpecDirectoryContents.length; i++) {
				if (ECSpecDirectoryContents[i].getName().endsWith(".xml")) {
					...
					ecspecNodeChild.setText(ECSpecDirectoryContents[i].getName());
				}
			}
		}
	}
	...
	private void initializeAvailableReadersList() {
		...
		if (HALDirectoryContents.length != 0) {
			for (int i = 0; i < HALDirectoryContents.length; i++) {
				if (HALDirectoryContents[i].getName().endsWith(".xml")) {
					...
					// dynamic reader
					try {
						File selectedFile = new File(PreferenceConstants.P_HAL_LRSpecsPATH + HALDirectoryContents[i].getName());
					...
					if (root.equals("LogicalReaders")) {
						...
						ecspecAvailableReadersList.add(lrSpecNodeList.item(0).getAttributes().item(0).getNodeValue());
					}
		...
		if (RPDirectoryContents.length != 0) {
			for (int i = 0; i < RPDirectoryContents.length; i++) {
				if (RPDirectoryContents[i].getName().endsWith(".xml")) {
					...
					// dynamic reader
					try {
						File selectedFile = new File(PreferenceConstants.P_RP_LRSpecsPATH + RPDirectoryContents[i].getName());
		...
		if (LLRPDirectoryContents.length != 0) {
			for (int i = 0; i < LLRPDirectoryContents.length; i++) {
				if (LLRPDirectoryContents[i].getName().endsWith(".xml")) {
					...
					// dynamic reader
					try {
						File selectedFile = new File(PreferenceConstants.P_LLRP_LRSpecsPATH + LLRPDirectoryContents[i].getName());
		...
		if (exists("org.ow2.aspirerfid.ide.aleconfig.Activator")) {// added By
			...
			readerNamesArray = lrspecConfigPreferences.getString(org.ow2.aspirerfid.ide.aleconfig.preferences.PreferenceConstants.P_ReaderNames)
					.split(",");
	...
	private class EcspecResetButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			...
			for (int i = 0; i < ecspecIncludedReadersList.getItemCount(); i++) {
				ecspecAvailableReadersList.add(ecspecIncludedReadersList.getItem(i));
			}
	...
	private class EcspecAddReaderButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (availableToIncludedReaders[0] == "") {
				...
				ecspecAvailableReadersList.remove(availableToIncludedReaders[0]);

				// add reader to ecspec
				ecSpecIncludedLogicalReadersList.add(availableToIncludedReaders[0]);
	...
	private class EcspecTruncateReaderButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (includedToAvailableReaders[0] == "") {
				...
				ecSpecIncludedLogicalReadersList.remove(includedToAvailableReaders[0]);
	...
	private class EcspecGenerateXMLButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			...
			if (ecspecIncludedReadersList.getItemCount() == 0) {
				MessageDialog.openError(container.getShell(), "Error", "Included readers list should be filled!");

			}
			else if (reportsList.getItemCount() == 0) {
				MessageDialog.openError(container.getShell(), "Error", "Reports list should be filled!");

			}
			else {
				// set readers
				ecSpecBuilder.setLogicalReaders(ecSpecIncludedLogicalReadersList);

				// set Include Spec In reports
				ecSpecBuilder.setIncludeSpecInreports(includeSpecInReportCheckBox.getSelection());

				/* set ECBoundarySpec */

				// set start trigger
				ecBoundarySpecBuilder.getECBoundarySpec().setStartTrigger(ecBoundarySpecStartTriggerText.getText());

				// set start trigger list
				if (ecspecStartTriggerList.getItemCount() != 0) {
					for (int i = 0; i < ecspecStartTriggerList.getItemCount(); i++) {
						startTriggerList.getStartTrigger().add(ecspecStartTriggerList.getItem(i));
					}
					ecBoundarySpecExtension.setStartTriggerList(startTriggerList);
				}

				// set stop trigger
				ecBoundarySpecBuilder.getECBoundarySpec().setStopTrigger(ecBoundarySpecStopTriggerText.getText());

				// set stop trigger list
				if (ecspecStopTriggerList.getItemCount() != 0) {
					for (int i = 0; i < ecspecStopTriggerList.getItemCount(); i++) {
						stopTriggerList.getStopTrigger().add(ecspecStopTriggerList.getItem(i));
					}
					ecBoundarySpecExtension.setStopTriggerList(stopTriggerList);
				}

				// set repeat period
				ecBoundarySpecBuilder.setRepeatPeriod(Integer.parseInt(ecBoundarySpecRepeatPeriodValueText.getText()));

				// set duration
				ecBoundarySpecBuilder.setDuration(Integer.parseInt(ecBoundarySpecDurationValueText.getText()));

				// set stable set interval
				ecBoundarySpecBuilder.setStableSetInterval(Integer.parseInt(ecBoundarySpecStableSetIntervalValueText.getText()));

				// set when data available
				if (ecspecWhenDataAvailableCheckBox.getSelection() == true) {
					ecBoundarySpecExtension.setWhenDataAvailable(ecspecWhenDataAvailableCheckBox.getSelection());
				}
				...
				ecSpecBuilder.getECBoundarySpec().getECBoundarySpec().setExtension(ecBoundarySpecExtension);
				...
				try {
					...
					ecspecNodeChild = new TreeItem(ECSpecsNode, SWT.NULL);
					ecspecNodeChild.setText(selection.substring(selection.lastIndexOf("\\") + 1));
	...
	private class IncludePatternsAddButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (includePatternsText.getText().equals("")) {
				MessageDialog.openError(container.getShell(), "Error", "No pattern has been entered!");
	...
	private class EcBoundarySpecRepeatPeriodValueTextVerifyListener implements VerifyListener {
	...
	private class EcBoundarySpecDurationValueTextVerifyListener implements VerifyListener {
		public void verifyText(final VerifyEvent arg0) {
			String string = arg0.text;
			char[] chars = new char[string.length()];
			string.getChars(0, chars.length, chars, 0);
	...
	private class EcBoundarySpecStableSetIntervalValueTextVerifyListener implements VerifyListener {
		public void verifyText(final VerifyEvent arg0) {
			String string = arg0.text;
			char[] chars = new char[string.length()];
			string.getChars(0, chars.length, chars, 0);
	...
	private class IncludePatternsUpdateButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (includePatternsText.getText().equals("")) {
				MessageDialog.openError(container.getShell(), "Error", "No pattern has been selected!");

			}
			else if (includePatternsText.getText() != "" && includePatternsList.getItemCount() == 0) {
				MessageDialog.openError(container.getShell(), "Error", "No patterns available to update!");

			}
			else {
				includePatternsList.remove(includePatternsListSelectedIndex);
				includePatternsList.add(includePatternsText.getText(), includePatternsListSelectedIndex);
				includePatternsText.setText("");
			}
		}
	}
	...
	private class IncludePatternsDeleteButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (includePatternsText.getText().equals("")) {
				...
				MessageDialog.openError(container.getShell(), "Error", "No patterns available to delete!");
	...
	private class ExcludePatternsUpdateButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			...
			else if (excludePatternsText.getText() != "" && excludePatternsList.getItemCount() == 0) {
				MessageDialog.openError(container.getShell(), "Error", "No patterns available to update!");

			}
			else {
				excludePatternsList.remove(excludePatternsListSelectedIndex);
				excludePatternsList.add(excludePatternsText.getText(), excludePatternsListSelectedIndex);
				excludePatternsText.setText("");
			}
		}
	}
	...
	private class PatternUpdateButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			...
			else if (groupSpecURIPatternText.getText() != "" && patternList.getItemCount() == 0) {
				MessageDialog.openError(container.getShell(), "Error", "No patterns available to update!");

			}
			else {
				patternList.remove(patternListSelectedIndex);
				patternList.add(groupSpecURIPatternText.getText(), patternListSelectedIndex);
				groupSpecURIPatternText.setText("");
			}
		}
	}
	...
	private class ReportAddButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (reportNameText.getText().equals("")) {
				MessageDialog.openError(container.getShell(), "Error", "Report name field should be filled!");

			}
			else if (ecReportSpecReportSetCombo.getText().equals("")) {
				MessageDialog.openError(container.getShell(), "Error", "Report set field should be filled!");

			}
			else if (includeEpcCheck.getSelection() == false) {
				MessageDialog.openError(container.getShell(), "Error", "Include EPC field should be filled!");
				...
				// set reportIfEmpty
				ecReportSpec.setReportIfEmpty(reportIfEmptyCheck.getSelection());

				// set reportOnlyOnChange
				ecReportSpec.setReportOnlyOnChange(reportOnlyOnChangeCheck.getSelection());
				...
				if (ecReportSpecReportSetCombo.getText().equals("CURRENT")) {
					ecReportSetSpec.setSet(ECReportSpecBuilder.ReportSet.CURRENT.toString());
					ecReportSpec.setReportSet(ecReportSetSpec);
				}
				else if (ecReportSpecReportSetCombo.getText().equals("ADDITIONS")) {
					ecReportSetSpec.setSet(ECReportSpecBuilder.ReportSet.ADDITIONS.toString());
					ecReportSpec.setReportSet(ecReportSetSpec);
				}
				else if (ecReportSpecReportSetCombo.getText().equals("DELETIONS")) {
					ecReportSetSpec.setSet(ECReportSpecBuilder.ReportSet.DELETIONS.toString());
					ecReportSpec.setReportSet(ecReportSetSpec);
				}
				...
				for (int i = 0; i < includePatternsList.getItemCount(); i++) {
					includePatterns.getIncludePattern().add(includePatternsList.getItem(i));
				}

				for (int i = 0; i < excludePatternsList.getItemCount(); i++) {
					excludePatterns.getExcludePattern().add(excludePatternsList.getItem(i));
				}
				...
				ecReportOutputSpec.setIncludeCount(includeCountCheck.getSelection());
				ecReportOutputSpec.setIncludeEPC(includeEpcCheck.getSelection());
				ecReportOutputSpec.setIncludeRawDecimal(includeRawDecimalCheck.getSelection());
				ecReportOutputSpec.setIncludeRawHex(includeRawHexCheck.getSelection());
				ecReportOutputSpec.setIncludeTag(includeTagCheck.getSelection());
	...
	private class ReportSpecsUpdateButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			...
			if (reportsListSelectedIndex == -1) {
				MessageDialog.openError(container.getShell(), "Error", "No report has been selected!");
				...
				ecSpecBuilder.getECReportSpecs().add(reportsListSelectedIndex, ecReportSpec);

				reportsList.remove(reportsListSelectedIndex);

				// add to Reports list the report
				reportsList.add(ecReportSpec.getReportName(), reportsListSelectedIndex);
	...
	private void loadReportListItemData(ECSpecBuilder ecSpecBuilder, int reportsListSelectedIndex) {
		reportNameText.setText(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getReportName());

		ecReportSpecReportSetCombo.setText(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getReportSet().getSet().toString());

		for (int i = 0; i < ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getFilterSpec().getIncludePatterns().getIncludePattern()
				.size(); i++) {
			includePatternsList.add(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getFilterSpec().getIncludePatterns()
					.getIncludePattern().get(i));
		}

		for (int i = 0; i < ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getFilterSpec().getExcludePatterns().getExcludePattern()
				.size(); i++) {
			excludePatternsList.add(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getFilterSpec().getExcludePatterns()
					.getExcludePattern().get(i));
		}

		for (int i = 0; i < ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getGroupSpec().getPattern().size(); i++) {
			patternList.add(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getGroupSpec().getPattern().get(i));
		}

		includeEpcCheck.setSelection(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getOutput().isIncludeEPC());
		includeTagCheck.setSelection(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getOutput().isIncludeTag());
		includeCountCheck.setSelection(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getOutput().isIncludeCount());
		includeRawHexCheck.setSelection(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getOutput().isIncludeRawHex());
		includeRawDecimalCheck.setSelection(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).getOutput().isIncludeRawDecimal());

		reportIfEmptyCheck.setSelection(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).isReportIfEmpty());
		reportOnlyOnChangeCheck.setSelection(ecSpecBuilder.getECReportSpecs().get(reportsListSelectedIndex).isReportOnlyOnChange());
	}
	...
	private class EcspecOpenFileButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			...
			try {
				...
				for (int i = 0; i < ecSpec.getLogicalReaders().getLogicalReader().size(); i++) {
					ecspecIncludedReadersList.add(ecSpec.getLogicalReaders().getLogicalReader().get(i));
				}

				for (int i = 0; i < ecspecIncludedReadersList.getItemCount(); i++) {
					for (int j = 0; j < ecspecAvailableReadersList.getItemCount(); j++) {
						if (ecspecIncludedReadersList.getItem(i).equals(ecspecAvailableReadersList.getItem(j))) {
				...
				if (ecSpec.getBoundarySpec().getStartTrigger() != null) {
					ecBoundarySpecStartTriggerText.setText(ecSpec.getBoundarySpec().getStartTrigger());
				}

				if (ecSpec.getBoundarySpec().getStopTrigger() != null) {
					ecBoundarySpecStopTriggerText.setText(ecSpec.getBoundarySpec().getStopTrigger());
				}

				if (ecSpec.getBoundarySpec().getExtension() != null) {
					if (ecSpec.getBoundarySpec().getExtension().getStartTriggerList() != null) {
						for (int i = 0; i < ecSpec.getBoundarySpec().getExtension().getStartTriggerList().getStartTrigger().size(); i++) {
							ecspecStartTriggerList.add(ecSpec.getBoundarySpec().getExtension().getStartTriggerList().getStartTrigger().get(i));
						}
					}

					if (ecSpec.getBoundarySpec().getExtension().getStopTriggerList() != null) {
						for (int i = 0; i < ecSpec.getBoundarySpec().getExtension().getStopTriggerList().getStopTrigger().size(); i++) {
							ecspecStopTriggerList.add(ecSpec.getBoundarySpec().getExtension().getStopTriggerList().getStopTrigger().get(i));
						}
					}

					if (ecSpec.getBoundarySpec().getExtension().isWhenDataAvailable() != null) {
						ecspecWhenDataAvailableCheckBox.setSelection(ecSpec.getBoundarySpec().getExtension().isWhenDataAvailable());
					}
				}

				if (ecSpec.getBoundarySpec().getRepeatPeriod() != null) {
					ecBoundarySpecRepeatPeriodValueText.setText(String.valueOf(ecSpec.getBoundarySpec().getRepeatPeriod().getValue()));
				}

				if (ecSpec.getBoundarySpec().getDuration() != null) {
					ecBoundarySpecDurationValueText.setText(String.valueOf(ecSpec.getBoundarySpec().getDuration().getValue()));
				}

				if (ecSpec.getBoundarySpec().getStableSetInterval() != null) {
					ecBoundarySpecStableSetIntervalValueText.setText(String.valueOf(ecSpec.getBoundarySpec().getStableSetInterval().getValue()));
				}

				includeSpecInReportCheckBox.setSelection(ecSpec.isIncludeSpecInReports());

				if (ecSpec.getReportSpecs().getReportSpec() != null) {
					for (int i = 0; i < ecSpec.getReportSpecs().getReportSpec().size(); i++) {
						if (ecSpec.getReportSpecs().getReportSpec().get(i).getReportName() != null) {
							reportsList.add(ecSpec.getReportSpecs().getReportSpec().get(i).getReportName());
						}
					}
				}
				...
				for (int i = 0; i < ecSpec.getLogicalReaders().getLogicalReader().size(); i++) {
					ecSpecIncludedLogicalReadersList.add(ecSpec.getLogicalReaders().getLogicalReader().get(i));
				}

				ecSpecBuilder.setLogicalReaders(ecSpecIncludedLogicalReadersList);

				ecSpecBuilder.setIncludeSpecInreports(ecSpec.isIncludeSpecInReports());

				if (ecSpec.getBoundarySpec().getRepeatPeriod() != null) {
					ecBoundarySpecBuilder.setRepeatPeriod(ecSpec.getBoundarySpec().getRepeatPeriod().getValue());
				}

				if (ecSpec.getBoundarySpec().getDuration() != null) {
					ecBoundarySpecBuilder.setDuration(ecSpec.getBoundarySpec().getDuration().getValue());
				}

				if (ecSpec.getBoundarySpec().getStableSetInterval() != null) {
					ecBoundarySpecBuilder.setStableSetInterval(ecSpec.getBoundarySpec().getStableSetInterval().getValue());
				}

				ecBoundarySpecBuilder.getECBoundarySpec().setStartTrigger(ecSpec.getBoundarySpec().getStartTrigger());
				...
				ecBoundarySpecBuilder.getECBoundarySpec().setStopTrigger(ecSpec.getBoundarySpec().getStopTrigger());
				...
				for (int i = 0; i < ecSpec.getReportSpecs().getReportSpec().size(); i++) {
					ecReportSpec.setReportIfEmpty(ecSpec.getReportSpecs().getReportSpec().get(i).isReportIfEmpty());
					ecReportSpec.setReportOnlyOnChange(ecSpec.getReportSpecs().getReportSpec().get(i).isReportOnlyOnChange());
					ecReportSpec.setReportName(ecSpec.getReportSpecs().getReportSpec().get(i).getReportName());

					ecReportSetSpec.setSet(ecSpec.getReportSpecs().getReportSpec().get(i).getReportSet().getSet());
					ecReportSpec.setReportSet(ecReportSetSpec);

					/* set ECFilterSpec */
					if (ecSpec.getReportSpecs().getReportSpec().get(i).getFilterSpec() != null) {
						for (int j = 0; j < ecSpec.getReportSpecs().getReportSpec().get(i).getFilterSpec().getIncludePatterns().getIncludePattern()
								.size(); j++) {

							if (ecSpec.getReportSpecs().getReportSpec().get(i).getFilterSpec().getIncludePatterns().getIncludePattern().get(j) != null) {
								includePatterns.getIncludePattern().add(
										ecSpec.getReportSpecs().getReportSpec().get(i).getFilterSpec().getIncludePatterns().getIncludePattern()
												.get(j));
							}
						}
					}
					...
					if (ecSpec.getReportSpecs().getReportSpec().get(i).getFilterSpec() != null) {
						for (int j = 0; j < ecSpec.getReportSpecs().getReportSpec().get(i).getFilterSpec().getExcludePatterns().getExcludePattern()
								.size(); j++) {
							if (ecSpec.getReportSpecs().getReportSpec().get(i).getFilterSpec().getExcludePatterns().getExcludePattern().get(j) != null) {
								excludePatterns.getExcludePattern().add(
										ecSpec.getReportSpecs().getReportSpec().get(i).getFilterSpec().getExcludePatterns().getExcludePattern()
												.get(j));
							}
						}
					}
					...
					// set ECGroupSpec to ECReportSpec
					if (ecSpec.getReportSpecs().getReportSpec().get(i).getGroupSpec() != null) {
						for (int j = 0; j < ecSpec.getReportSpecs().getReportSpec().get(i).getGroupSpec().getPattern().size(); j++) {
							if (ecSpec.getReportSpecs().getReportSpec().get(i).getGroupSpec().getPattern().get(j) != null) {
								ecGroupSpec.getPattern().add(ecSpec.getReportSpecs().getReportSpec().get(i).getGroupSpec().getPattern().get(j));
							}
						}
					}
					ecReportSpec.setGroupSpec(ecGroupSpec);
					...
					/* set ECReportOutputSpec */
					ecReportOutputSpec.setIncludeCount(ecSpec.getReportSpecs().getReportSpec().get(i).getOutput().isIncludeCount());
					ecReportOutputSpec.setIncludeEPC(ecSpec.getReportSpecs().getReportSpec().get(i).getOutput().isIncludeEPC());
					ecReportOutputSpec.setIncludeRawDecimal(ecSpec.getReportSpecs().getReportSpec().get(i).getOutput().isIncludeRawDecimal());
					ecReportOutputSpec.setIncludeRawHex(ecSpec.getReportSpecs().getReportSpec().get(i).getOutput().isIncludeRawHex());
					ecReportOutputSpec.setIncludeTag(ecSpec.getReportSpecs().getReportSpec().get(i).getOutput().isIncludeTag());
					/* end of ECReportOutputSpec */
	...
	private class EcspectreeMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			...
			try {
				ECSpec ecSpec = new ECSpec();
				ecSpec = openEcSpecBuilder.getECSpecFromFile(PreferenceConstants.P_ECSpecsPATH + ecspectreeSelectedItem);

				existingECSpecFileToBeSaved = PreferenceConstants.P_ECSpecsPATH + ecspectreeSelectedItem;
	...
	private class EcspecStartTriggerAddButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (ecBoundarySpecStartTriggerText.getText().equals("")) {
				MessageDialog.openError(container.getShell(), "Error", "No start trigger has been entered!");

			}
			else {
				ecspecStartTriggerList.add(ecBoundarySpecStartTriggerText.getText());
				ecBoundarySpecStartTriggerText.setText("");
			}
		}
	}

	private class EcspecStartTriggerListUpdateButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (ecBoundarySpecStartTriggerText.getText().equals("")) {
				MessageDialog.openError(container.getShell(), "Error", "No start trigger has been selected!");

			}
			else if (ecBoundarySpecStartTriggerText.getText() != "" && ecspecStartTriggerList.getItemCount() == 0) {
				MessageDialog.openError(container.getShell(), "Error", "No start triggers available to update!");

			}
			else {
				ecspecStartTriggerList.remove(startTriggerListSelectedIndex);
				ecspecStartTriggerList.add(ecBoundarySpecStartTriggerText.getText(), startTriggerListSelectedIndex);
				ecBoundarySpecStartTriggerText.setText("");
			}
		}
	}

	private class EcspecStartTriggerListDeleteButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (ecBoundarySpecStartTriggerText.getText().equals("")) {
				MessageDialog.openError(container.getShell(), "Error", "No start trigger has been selected!");
				...
				MessageDialog.openError(container.getShell(), "Error", "No start triggers available to delete!");
	...
	private class EcspecStopTriggerAddButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (ecBoundarySpecStopTriggerText.getText().equals("")) {
				MessageDialog.openError(container.getShell(), "Error", "No stop trigger has been entered!");

			}
			else {
				ecspecStopTriggerList.add(ecBoundarySpecStopTriggerText.getText());
				ecBoundarySpecStopTriggerText.setText("");
			}
		}
	}

	private class EcspecStopTriggerListUpdateButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (ecBoundarySpecStopTriggerText.getText().equals("")) {
				MessageDialog.openError(container.getShell(), "Error", "No stop trigger has been selected!");

			}
			else if (ecBoundarySpecStopTriggerText.getText() != "" && ecspecStopTriggerList.getItemCount() == 0) {
				MessageDialog.openError(container.getShell(), "Error", "No stop trigger available to update!");

			}
			else {
				ecspecStopTriggerList.remove(stopTriggerListSelectedIndex);
				ecspecStopTriggerList.add(ecBoundarySpecStopTriggerText.getText(), stopTriggerListSelectedIndex);
				ecBoundarySpecStopTriggerText.setText("");
			}
		}
	}

	private class EcspecStopTriggerListDeleteButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			if (ecBoundarySpecStopTriggerText.getText().equals("")) {
				MessageDialog.openError(container.getShell(), "Error", "No stop trigger has been selected!");
				...
				MessageDialog.openError(container.getShell(), "Error", "No stop trigger available to delete!");
